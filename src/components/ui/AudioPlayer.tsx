  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <button
        onClick={togglePlay}
        disabled={isLoading}
        className="transition-opacity cursor-pointer disabled:opacity-50"
      ...
      <div className="flex-1 flex items-center gap-2">
        <span className="text-xs min-w-[30px] tabular-nums" style={{ color: "var(--workspace-text-muted)" }}>
        ...
        <input
          ...
          className={`flex-1 h-1 rounded-lg appearance-none cursor-pointer focus:outline-none focus:ring-1 focus:ring-[var(--workspace-accent)] ${progressPercent >= 99.5 ? "[&::-webkit-slider-thumb]:translate-x-0.5 [&::-moz-range-thumb]:translate-x-0.5" : ""}`}
          style={{
            background: `linear-gradient(to right, var(--workspace-accent) 0%, var(--workspace-accent) ${progressPercent}%, rgba(143, 112, 105, 0.2) ${progressPercent}%, rgba(143, 112, 105, 0.2) 100%)`,
          }}
        />
