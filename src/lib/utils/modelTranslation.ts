...
type ModelInfoWithCategory = ModelInfo & {
  category?: "Transcription" | "Embedding" | "Llm";
};
...
export function getModelCategory(
  model: ModelInfo,
): "Transcription" | "Embedding" | "Llm" {
  return (model as ModelInfoWithCategory).category ?? "Transcription";
}
