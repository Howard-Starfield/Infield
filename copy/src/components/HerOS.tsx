...
export const HerOSBackground: React.FC = () => {
  return (
    <>
      {/* ── Layer 0: Liquid blob kinetic background ── */}
      ...
      {/* ── Layer 1: Central light bloom on top of blobs ── */}
      <div style={{
        position: 'absolute', top: '50%', left: '50%',
        transform: 'translate(-50%, -50%)',
        width: '80%', height: '80%',
        background: 'radial-gradient(circle, rgba(240, 216, 208, 0.12) 0%, transparent 70%)',
...
export const HerOSInput: React.FC<HerOSInputProps> = ({ icon, type, style, ...props }) => {
